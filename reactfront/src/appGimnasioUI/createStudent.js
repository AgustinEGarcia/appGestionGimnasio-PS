        ...
        <div className="container_grilla_ingresar">
            ...
            <form onSubmit={save}>
                ...
                <div className="input-group mt-3">
                    ...
                    <select className="form-select imput_form_control" id="inputGroupSelect01" onChange={(e) => setTipo_membresia(e.target.value)}>
                ...
                <div className="input-group mt-3">
                    <label className="input-group-text imput_group_text" htmlFor="inputGroupSelect02">Turno asignado</label>
                    <select disabled={Tipo_membresia!=='Preferencial'} value={Turno_asignado} className="form-select imput_form_control" id="inputGroupSelect02" onChange={(e) => setTurno_asignado(Number(e.target.value))}>
                        <option className="option_value" defaultValue>Seleccione una</option>
                        {horariosDisponibles.map((element, index) => 
                            
                            <option className="option_value" key={index} value= {element} >{element}hs</option>
